...
const Portfolio = () => {
  ...
  const projects = [
    {
      title: "A.T.L.S",
      videoDemo: "https://youtu.be/qq7OISxOzD0",
      description: `ATLS (Automated Travel and Logistics System) is a comprehensive defense technology solution developed during the Palantir Winter Defense Tech Fellowship that streamlines military briefing preparation. The system combines multiple advanced technologies: RAG (Retrieval-Augmented Generation) for processing cultural intelligence, and Palantir Foundry's pipeline architecture with AIP logic functions for automating travel advisory and logistics information. By leveraging these complementary approaches, ATLS transforms the traditional manual briefing process into an efficient, automated workflow that maintains high accuracy standards.`,
      images: ["/images/atl_1.png", "/images/atl_2.png"],
      tech: ["Palantir Foundry", "RAG", "AIP", "Data Pipelining"],
